<template>
  <div class="bg-white rounded-lg shadow-sm">
    <div
      ...
      "
    >
      <span>{{ electorate.name }} ({{ electorate.margin }}%)</span>
      <span
        class="text-white py-1 px-3 text-xs rounded-md"
        :class="'bg-' + electorate.party.toLowerCase()"
        >{{ electorate.party }}</span
      >
    </div>
    <div class="px-4 font-bold text-xl text-gray-900 mb-6">
    ...
    <div
      ...
      :style="
        ...
        (electorate.margin + 50) +
        '%, #f3f4f6 ' +
        (electorate.margin + 50.01) +
        '%, #f3f4f6 100%)'
      "
    >
      <div
        class="
          ...
          -translate-x-1/2
        "
        :style="'left:' + (electorate.margin + 50) + '%'"
      />
    </div> -->
